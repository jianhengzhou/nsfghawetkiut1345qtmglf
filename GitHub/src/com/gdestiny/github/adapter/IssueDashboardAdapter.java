...
public class IssueDashboardAdapter extends BaseAdapter {

	private Context context;
	private List<RepositoryIssue> datas;
	...
	public IssueDashboardAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		RepositoryIssue issue = datas.get(position);
	...
	public List<RepositoryIssue> getDatas() {
		return datas;
	}

	public void setDatas(List<RepositoryIssue> datas) {
		this.datas = datas;
