...
public class ImageViewEx extends ImageView {
	...
	public static final String TAG = "imageview_ex";
	...
	public ImageViewEx(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.imageview_ex, defStyle, 0);

		final int index = a.getInt(R.styleable.imageview_ex_android_scaleType,
				-1);
		if (index >= 0) {
		...
		mLeftTopCornerRadius = a.getDimensionPixelSize(
				R.styleable.imageview_ex_sriv_left_top_corner_radius, 0);
		mRightTopCornerRadius = a.getDimensionPixelSize(
				R.styleable.imageview_ex_sriv_right_top_corner_radius, 0);
		mLeftBottomCornerRadius = a.getDimensionPixelSize(
				R.styleable.imageview_ex_sriv_left_bottom_corner_radius, 0);
		mRightBottomCornerRadius = a.getDimensionPixelSize(
				R.styleable.imageview_ex_sriv_right_bottom_corner_radius, 0);
		...
		mBorderWidth = a.getDimensionPixelSize(
				R.styleable.imageview_ex_sriv_border_width, 0);
		if (mBorderWidth < 0) {
			throw new IllegalArgumentException(
		...
		mBorderColor = a
				.getColorStateList(R.styleable.imageview_ex_sriv_border_color);
		if (mBorderColor == null) {
			mBorderColor = ColorStateList.valueOf(DEFAULT_BORDER_COLOR);
		}

		isOval = a.getBoolean(R.styleable.imageview_ex_sriv_oval, false);
		a.recycle();
	...
	public void setCornerRadiusesDP(float leftTop, float rightTop,
